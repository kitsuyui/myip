...
func IPRetrievables() []base.ScoredIPRetrievable {
	...
	return []base.ScoredIPRetrievable{
		...
		scored{IPRetrievable: http{URL: "http://smart-ip.net/myip"}, Weight: 1.0, IPv4: true, IPv6: true},
		...
		scored{IPRetrievable: stun{Host: "stun:stun.ipcomms.net:3478", Protocol: "udp"}, Weight: 1.0, IPv4: true, IPv6: false},
		...
		scored{IPRetrievable: stun{Host: "stun:stun.3cx.com:3478", Protocol: "udp"}, Weight: 1.0, IPv4: true, IPv6: false},
		scored{IPRetrievable: stun{Host: "stun:stun.avigora.fr:3478", Protocol: "tcp"}, Weight: 1.0, IPv4: true, IPv6: false},
		scored{IPRetrievable: stun{Host: "stun:stun.advfn.com:3478", Protocol: "udp"}, Weight: 1.0, IPv4: true, IPv6: false},
